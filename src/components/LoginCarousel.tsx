  ...
  return (
    <>
      ...
      <div className="flex flex-col gap-2 pb-8">
        <h2 className="text-summit-900 min-h-24 text-4xl font-semibold">
        ...
        <div className="flex items-center gap-2">
          <button
            className={classNames(
              ...
              current === 1 ? "bg-summit-900 w-12" : "w-6 bg-white",
            )}
            onClick={() => {
              if (api) {
                api.scrollTo(0);
          ...
          <button
            className={classNames(
              "h-2 rounded-lg transition-all duration-300",
              current === 2 ? "bg-summit-900 w-12" : "w-6 bg-white",
            )}
            onClick={() => {
              if (api) {
                api.scrollTo(1);
          ...
          <button
            className={classNames(
              "h-2 rounded-lg transition-all duration-300",
              current === 3 ? "bg-summit-900 w-12" : "w-6 bg-white",
            )}
            onClick={() => {
              if (api) {
                api.scrollTo(2);
