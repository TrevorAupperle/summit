...
export default function Home() {
  ...
  return (
    <>
      ...
      <main className=" flex min-h-screen flex-col items-center justify-center bg-gradient-to-b from-[#354F52] to-[#D1D5DB]">
        <div className="container flex flex-col items-center justify-center gap-12 px-4 py-16 ">
          <h1 className="text-white text-5xl font-extrabold tracking-tight sm:text-[5rem]">
            Create <span className="text-[#2F3E46]">T3</span> App
          </h1>
          ...
          <div className="flex flex-col items-center gap-2">
            ...
            <Link
              href="/signin"
              className="bg-white text-white rounded-full bg-opacity-10 px-10  py-3 font-semibold hover:bg-opacity-20"
            >
              SignIn2
            </Link>
            <Link
